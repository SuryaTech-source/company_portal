...
module.exports = function (app, io) {
  try {
    ...
    const walkthroughImage =
      require("../controller/admin/walkthrough-images.js")(app);
    ...
    var fleetAssignment = require("../controller/admin/fleetassignment.js")(
      app
    );
    var salaryController = require("../controller/admin/salary.js")(app);
    var alertController = require("../controller/admin/alert.js")(app);
    ...
    app.post(
      "/paymentGateway/save",
      ensureAuthorized,
      middlewares.commonUpload(CONFIG.DIRECTORY_OTHERS).any(),
      payment.save
    );
    ...
    app.post(
      "/admins/getdeleted/subadmins",
      ensureAuthorized,
      admins.deletedSubAdmins
    );
    ...
    app.post(
      "/admins/multichangeStatus",
      ensureAuthorized,
      admins.multichangeStatus
    );
    app.post(
      "/admins/changeAvailbility",
      ensureAuthorized,
      admins.changeAvailbility
    );
    ...
    app.post(
      "/dashboard/deleteDriver",
      ensureAuthorized,
      drivers.deletdriverdata
    );
    app.post("/driver/dashboard", ensureAuthorized, drivers.driversDashboard);
    app.post(
      "/driver/getDriverRestStatics",
      ensureAuthorized,
      drivers.getDriverRestStatics
    );
    ...
    app.post(
      "/banners/type",
      ensureAuthorized,
      middlewares.commonUpload(CONFIG.DIRECTORY_OTHERS).single("image"),
      middlewares.commonUpload(CONFIG.DIRECTORY_OTHERS).convertToWebP,
      banners.bannerType
    );
    app.post(
      "/offer/addedit",
    ...
    app.post(
      "/banners/batchs",
      ensureAuthorized,
      middlewares.commonUpload(CONFIG.DIRECTORY_OTHERS).fields([
        { name: "image_1", maxCount: 1 },
        { name: "image_2", maxCount: 1 },
        { name: "image_3", maxCount: 1 },
        { name: "image_4", maxCount: 1 },
      ]),
      banners.bannerBatchType
    );
    app.post(
    ...
    app.post(
      "/get/offermanagement",
      ensureAuthorized,
      banners.getoffermanagement
    );
    app.post(
      "/get/testimonialmanagement",
      ensureAuthorized,
      banners.getTestimonialmanagement
    );
    ...
    app.post(
      "/banners/permanent/delete",
      ensureAuthorized,
      banners.webPermanentdelete
    );
    ...
    app.post(
      "/rcategory/export_category",
      ensureAuthorized,
      rcategory.exportCategoryList,
      middlewares.exportToCSVCategory
    );
    ...
    app.post(
      "/walkthrough_image/list",
      ensureAuthorized,
      walkthroughImage.walkthroughImagesList
    );
    app.post(
      "/walkthrough_image/delete",
      ensureAuthorized,
      walkthroughImage.walkthroughImagesDelete
    );
    app.post(
      "/walkthrough_image/add",
      ensureAuthorized,
      middlewares.commonUpload(CONFIG.DIRECTORY_OTHERS).any(),
      walkthroughImage.walkthroughImagesAdd
    );
    app.post(
      "/walkthrough_image/edit",
      ensureAuthorized,
      walkthroughImage.walkthroughImagesEdit
    );
    app.post(
      "/walkthrough_image/dlist",
      ensureAuthorized,
      walkthroughImage.dwalthroughList
    );
    app.post(
      "/walkthrough_image/permenent_delete",
      ensureAuthorized,
      walkthroughImage.permanentDeleteWalkthrough
    );
    ...
    app.post(
      "/restaurant/deactiveUsers",
      ensureAuthorized,
      restaurant.deactiveUsers
    );
    app.post(
      "/restaurant/getdeletedusers",
      ensureAuthorized,
      restaurant.getdeletedusers
    );
    app.get(
      "/restarant/get/rcategory",
      ensureAuthorized,
    ...
    app.post(
      "/restaurant/walletAmount",
      ensureAuthorized,
      restaurant.walletAmount
    );
    app.post("/restaurant/addaddress", ensureAuthorized, restaurant.addaddress);
    app.post(
      "/restaurant/addressStatus",
      ensureAuthorized,
      restaurant.addressStatus
    );
    app.post(
      "/restaurant/deleteUserAddress",
      ensureAuthorized,
      restaurant.deleteUserAddress
    );
    app.get(
    ...
    app.post(
      "/restaurant/list/citybased",
      ensureAuthorized,
      restaurant.restaurantsList
    );
    app.post(
      "/restaurant/getFeaturedRestaurantList",
      ensureAuthorized,
      restaurant.getFeaturedRestaurantList
    );
    app.post(
      "/restaurant/changeRestaurantFeature",
      ensureAuthorized,
      restaurant.changeRestaurantFeature
    );
    app.post(
      "/restaurant/uploadRestaurantFeature",
      ensureAuthorized,
      middlewares.commonUpload(CONFIG.DIRECTORY_OTHERS).single("image"),
      restaurant.uploadRestaurantFeature
    );
    ...
    app.post(
      "/get/offer/editdoc",
      ensureAuthorized,
      restaurant.getOfferEditdoc
    );
    app.post("/offer/delete", ensureAuthorized, restaurant.deleteOffer);
    app.post(
      "/restarant/get/subcuisine",
      ensureAuthorized,
      restaurant.getsubCuisine
    );
    app.post("/rest/category/save", ensureAuthorized, restaurant.resCatSave);
    app.post(
      "/get_rest/category/list",
      ensureAuthorized,
      restaurant.resMaincatList
    );
    app.post(
      "/get_rest/category/catlist",
      ensureAuthorized,
      restaurant.resMaincataList
    );
    app.post(
      "/get_rest/subcategory/list",
      ensureAuthorized,
      restaurant.resSubcatList
    );
    app.post("/get_rest/menu/list", ensureAuthorized, restaurant.resMenuList);
    app.post(
      "/get_rest/recomended/list",
      ensureAuthorized,
      restaurant.resRecomendedList
    );
    app.post(
      "/rest/rec_food/data",
      ensureAuthorized,
      restaurant.getRecomendedFoodList
    );
    app.post(
      "/rest/save/rec_food/data",
      ensureAuthorized,
      restaurant.saveRecommended
    );
    app.post(
      "/rest/save/bank/data",
      ensureAuthorized,
      restaurant.saveBankDetails
    );

    app.post(
      "/rest/category/edit",
      ensureAuthorized,
      restaurant.resMaincatEdit
    );
    ...
    app.post(
      "/rest/sub_category/data",
      ensureAuthorized,
      restaurant.resSubCatdata
    );
    app.post(
      "/rest/category/delete",
      ensureAuthorized,
      restaurant.MainCatDelete
    );
    app.post(
      "/sub_cat/category/delete",
      ensureAuthorized,
      restaurant.subCatDelete
    );
    ...
    app.post(
      "/city/Restaurantdetails",
      ensureAuthorized,
      drivers.Restaurantdetails
    );
    ...
    app.post(
      ...
      ensureAuthorized,
      attributes.attDelete
    );

    /** ROUTERS for Time Slots **/
    app.get(
      "/admin/timeslots/timeslotsList",
      ensureAuthorized,
    ...
    app.post(
      "/food/getRestaurantCategory",
      ensureAuthorized,
      food.getRestaurantCategory
    );
    app.post(
      "/food/getSubCategoryDetails",
      ensureAuthorized,
      food.getSubCategoryDetails
    );
    app.post("/food/getproductlist", ensureAuthorized, food.getProductlist);
    app.post(
      "/food/exportproductlist",
      ensureAuthorized,
      food.exportProductlist,
      middlewares.exportToCSV
    );
    app.post(
      "/food/getproductlist_deals",
      ensureAuthorized,
      food.getProductlist_deals
    );
    ...
    app.get(
      "/food/editcategory/list",
      ensureAuthorized,
      food.exditcategoryList
    );
    ...
    app.post(
      "/food/bulkupload",
      ensureAuthorized,
      uploadExcelAndProcess,
      food.uploadBulkInventory
    );
    ...
    app.post(
      "/orders/getAssignJobOrder",
      ensureAuthorized,
      orders.getAssignJobOrder
    );
    app.post(
      "/orders/ordersDashboard1",
      ensureAuthorized,
      orders.ordersDashboard1
    );
    app.get(
    ...
    app.get(
      "/orders/todayFilterOrderDetails",
      ensureAuthorized,
      orders.todayFilterOrderDetails
    );
    app.get(
      "/orders/todayFilterOrderDetailsWithDriver",
      ensureAuthorized,
      orders.todayFilterOrderDetailsWithDriver
    );
    app.get(
      "/orders/todayFilterCompletedOrderDetails",
      ensureAuthorized,
      orders.todayFilterCompletedOrderDetails
    );
    app.post(
    ...
    app.post(
      "/refer_coupons/deletecoupon",
      ensureAuthorized,
      refer_coupon.deletecoupon
    );
    ...
    app.post(
      "/products/category/getCatrestid",
      ensureAuthorized,
      category.getCatrestid
    );
    ...
    app.post(
      ...
      middlewares.commonUpload(CONFIG.DIRECTORY_OTHERS).fields([
        ...
        { name: "taskersignup", maxCount: 1 },
        { name: "adminlogin", maxCount: 1 },
        { name: "loginpage", maxCount: 1 },
        { name: "taskerprofile", maxCount: 1 },
        { name: "sitelanding", maxCount: 1 },
      ]),
      images.save
    );
    app.post("/images/getappearance", images.getappearance);
    app.post(
      "/images/fixedHeaderSave",
      ensureAuthorized,
      images.fixedHeaderSave
    );
    ...
    app.post(
      "/pages/deletecategorypage",
      ensureAuthorized,
      pages.deletecategorypage
    );
    app.post(
      "/pages/submitcategoryPage",
      ensureAuthorized,
      pages.submitcategoryPage
    );
    app.post(
      "/pages/submi/footerdata",
      ensureAuthorized,
      pages.submitFooterData
    );
    ...
    app.post(
      "/settings/general/delete_splash_screen",
      settings.deleteSplashScreen
    );
    ...
    app.post(
      "/settings/referralStatus",
      ensureAuthorized,
      settings.referralStatus
    );
    app.post(
      "/settings/general/currency/save",
      ensureAuthorized,
      settings.currency
    );
    ...
    app.post(
      ...
      middlewares.commonUpload(CONFIG.DIRECTORY_OTHERS).fields([
        ...
        { name: "multiBase64", maxCount: 5 },
        { name: "footer_icon", maxCount: 1 },
        { name: "shipping_banner", maxCount: 1 },
        { name: "allcat_banner", maxCount: 1 },
      ]),
      settings.save
    );
    app.post(
      ...
      ensureAuthorized,
      settings.currencyList
    );
    app.post(
      "/settings/currency/edit",
      ensureAuthorized,
      settings.currencyEdit
    );
    app.post(
      "/settings/currency/save",
      ensureAuthorized,
      settings.currencySave
    );
    app.post(
      "/settings/currency/delete",
      ensureAuthorized,
      settings.currencyDelete
    );
    app.post(
      "/settings/mobilecontent/save",
      ensureAuthorized,
      settings.mobilesave
    );
    app.post(
      "/settings/currency/default/save",
      ensureAuthorized,
      settings.currencyDefaultSave
    );
    app.post(
      "/settings/restarant/default/save",
      ensureAuthorized,
      settings.restaurantDefaultSave
    );
    app.post("/settings/currency/default", settings.currencyDefault);

    app.post(
      "/settings/social-networks/save",
      ensureAuthorized,
      middlewares.commonUpload(CONFIG.DIRECTORY_OTHERS).fields([
        { name: "facebookimage", maxCount: 1 },
        { name: "twitterimage", maxCount: 1 },
        { name: "linkedinimage", maxCount: 1 },
        { name: "pinterestimage", maxCount: 1 },
        { name: "youtubeimage", maxCount: 1 },
        { name: "instagramimage", maxCount: 1 },
        { name: "googleimage", maxCount: 1 },
        { name: "googleplayimage", maxCount: 1 },
        { name: "googleplaylandingimage", maxCount: 1 },
        { name: "googplycommingsoonimage", maxCount: 1 },
        { name: "appstoreimage", maxCount: 1 },
        { name: "appstorelandingimage", maxCount: 1 },
        { name: "appstorecommingsoonimage", maxCount: 1 },
      ]),
      settings.socialnetworkssave
    );
    ...
    app.post(
      ...
      ensureAuthorized,
      settings.languageedit
    );
    app.get(
      "/settings/language/getlanguage/:id",
      ensureAuthorized,
      settings.languagegetlanguage
    );
    app.post(
      "/settings/language/list",
      ensureAuthorized,
      settings.languagelist
    );
    app.post(
      "/settings/language/delete",
      ensureAuthorized,
      settings.languagedelete
    );
    app.post("/settings/language/default", settings.languagedefault);
    app.post(
      "/settings/language/default/save",
      ensureAuthorized,
      settings.languagedefaultsave
    );
    app.post(
      "/settings/language/translation",
      ensureAuthorized,
      settings.languageTranslation
    );
    app.post(
      "/settings/language/translation/save",
      ensureAuthorized,
      settings.languageSaveTranslation
    );
    app.get(
      "/settings/language/translation/get",
      ensureAuthorized,
      settings.languageGetTranslation
    );
    app.post(
      "/settings/language/manage",
      ensureAuthorized,
      settings.getlanguageDetails
    );
    ...
    app.post(
      ...
      ensureAuthorized,
      newsletter.subscriberList
    );
    app.post(
      "/newsletter/subscriber/delete",
      ensureAuthorized,
      newsletter.subscriberDelete
    );
    app.post(
      "/newsletter/sendbulkmail",
      ensureAuthorized,
      newsletter.sendbulkmail
    );
    app.post(
    ...
    app.post(
      "/notification/driver/list",
      ensureAuthorized,
      newsletter.driverList
    );

    app.post(
      "/notification/email-template/list",
      ensureAuthorized,
      newsletter.emailtemplatelist
    );
    app.post(
      "/notification/email-template/edit",
      ensureAuthorized,
      newsletter.edittemplate
    );
    app.post(
      "/notification/email-template/save",
      ensureAuthorized,
      newsletter.savemailnotification
    );
    app.post(
      "/notification/message-template/save",
      ensureAuthorized,
      newsletter.savemessagenotification
    );
    app.post(
      "/notification/deletenotification",
      ensureAuthorized,
      newsletter.deletenotification
    );
    app.get(
      "/notification/email-template/getmailtemplate",
      ensureAuthorized,
      newsletter.getmailtemplate
    );
    app.get(
      "/notification/email-template/getmessagetemplate",
      ensureAuthorized,
      newsletter.getmessagetemplate
    );
    ...
    app.post(
      ...
      ensureAuthorized,
      middlewares
        .commonUpload(CONFIG.DIRECTORY_OTHERS)
        .fields([{ name: "og_image", maxCount: 1 }]),
      settings.seosave
    );
    ...
    app.get(
      "/emailtemplate/getsubscripermail",
      ensureAuthorized,
      emailTemplate.getsubscripermail
    );
    ...
    app.post(
      "/tools/exportrestaurant",
      ensureAuthorized,
      tools.restaurantexportpost
    );
    ...
    app.post(
      "/restarant/get/getRestaurants",
      ensureAuthorized,
      restaurant.getRestaurants
    );
    app.post(
      "/billing/adminEarnings",
      ensureAuthorized,
      billing_cycle.adminEarnings
    );
    app.post(
      "/billing/fetchCycles",
      ensureAuthorized,
      billing_cycle.fetchCycle
    );
    app.get(
      "/billing/driverEarnings",
      ensureAuthorized,
      billing_cycle.driverEarnings
    );
    app.get(
      "/billing/getDriverOrderEarnings",
      ensureAuthorized,
      billing_cycle.getDriverOrderEarnings
    );
    ...
    app.post(
      "/billing/updateRestaurantPayoutDetails",
      ensureAuthorized,
      billing_cycle.updateRestaurantPayoutDetails
    );
    // app.post('/billing/updateRestaurantPayoutAmount', ensureAuthorized, billing_cycle.updateRestaurantPayoutAmount);
    app.post(
      "/billing/updateDriverPayoutDetails",
      ensureAuthorized,
      billing_cycle.updateDriverPayoutDetails
    );
    app.get(
      "/billing/restaurantEarnings",
      ensureAuthorized,
      billing_cycle.restaurantEarnings
    );
    app.get(
      "/billing/getRestaurantOrderEarnings",
      ensureAuthorized,
      billing_cycle.getRestaurantOrderEarnings
    );
    // app.post('/billing/getRestaurantOrderEarningsAmount', ensureAuthorized, billing_cycle.getRestaurantOrderEarningsAmount);
    app.post(
      "/billing/getOrderDetails",
      ensureAuthorized,
      billing_cycle.getOrderDetails
    );
    ...
    app.post(
      "/reviews/rating/list",
      ensureAuthorized,
      ratings.RatingReviewList
    );
    app.post(
      "/reviews/rating/delete",
      ensureAuthorized,
      ratings.RatingReviewsDelete
    );
    app.post(
      "/reviews/rating/details",
      ensureAuthorized,
      ratings.RatingReviewDetails
    );
    ...
    app.post(
      "/testimonial-management/delete",
      ensureAuthorized,
      banners.deleteTestimonial
    );
    ...
    app.post(
      "/admin/fleet/save",
      ensureAuthorized,
      middlewares.commonUpload(CONFIG.DIRECTORY_OTHERS).single("document"),
      fleet.saveFleet
    );
    ...
    app.post(
      "/admin/fleet/maintenance-due",
      ensureAuthorized,
      fleet.maintenanceDue
    );
    ...
    app.post(
      "/admin/contract/active-list",
      ensureAuthorized,
      contract.listActiveContracts
    );
    //employee management
    app.post(
      "/admin/employee/save",
      ensureAuthorized,
      middlewares.commonUploadPDF(CONFIG.DIRECTORY_OTHERS).any(),
      middlewares.processDocuments,
    ...
    app.post(
      "/admin/fuel/fuel-stats",
      ensureAuthorized,
      fuel.fuelUsageAnalytics
    );
    app.post(
      "/admin/fuel/fuel-efficieny",
      ensureAuthorized,
      fuel.fuelEfficiencyAnalytics
    );
    app.post(
      "/admin/fuel/cost-per-km",
      ensureAuthorized,
    ...
    app.post(
      "/admin/sparepart/save",
      ensureAuthorized,
      sparepart.saveSparePart
    );
    app.post(
      "/admin/sparepart/list",
      ensureAuthorized,
      sparepart.listSpareParts
    );
    app.post(
      "/admin/sparepart/view",
      ensureAuthorized,
      sparepart.viewSparePart
    );
    ...
    app.post(
      ...
      ensureAuthorized,
      attendence.saveAttendance
    );
    app.post(
      "/admin/attendance/list",
      ensureAuthorized,
      attendence.listAttendance
    );
    app.post(
      "/admin/vendor/payment/save",
      ensureAuthorized,
      attendence.saveVendorPayment
    );
    app.post(
      "/admin/customer/payment/save",
      ensureAuthorized,
      attendence.saveCustomerPayment
    );
    app.post(
      "/admin/vendor/payment/list",
      ensureAuthorized,
      attendence.listVendorPayments
    );
    app.post(
      "/admin/customer/payment/list",
      ensureAuthorized,
      attendence.listCustomerPayments
    );
    app.post(
      "/admin/attendance/bulk-mark",
      ensureAuthorized,
      attendence.bulkMarkAttendance
    );
    app.post(
      "/admin/attendance/mark-all",
      ensureAuthorized,
      attendence.markAllPresentToday
    );
    ...
    app.post(
      "/admin/invoice/update-status",
      ensureAuthorized,
      invoice.updateInvoiceStatus
    );
    app.post(
      "/admin/invoice/invoice-contract",
      ensureAuthorized,
    ...
    app.post(
      "/admin/performance/update-driver-behaviour",
      performance.updateDrivingBehaviour
    );

    //fleet assignments
    app.post(
      "/admin/fleet/assignment/assign",
      ensureAuthorized,
      fleetAssignment.assignFleet
    );
    app.post(
      "/admin/fleet/assignment/list",
      ensureAuthorized,
      fleetAssignment.listFleetAssignments
    );
    app.post(
      "/admin/fleet/assignment/unassign",
      ensureAuthorized,
      fleetAssignment.unassignFleet
    );
    app.post(
      "/admin/fleet/assignment/assignment-stats",
      ensureAuthorized,
