...
const io = require('socket.io')(server, {
    cors: {
        origin: ["http://localhost:4200", "http://localhost:4201", 'http://localhost:4000',"https://company-portal-three.vercel.app", '*',"https://samilandmarks.com"],
        credentials: true
    },
    allowEIO3: true
});
...
app.use(function (req, res, next) {
    ...
    const allowedOrigins = ['*', 'http://localhost:4201', 'http://localhost:4000', 'http://localhost:4200',"https://company-portal-three.vercel.app", 'https://samilandmarks.com'];
